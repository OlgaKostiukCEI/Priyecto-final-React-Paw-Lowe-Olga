...
export const InfoPerros = () => {
  ...
  let actualizarInfoPerros = () => {
    ...
    if (infoPerros) {
      ...
      formularioActualizarInfoPerros.current["Imagen"].value =
        infoPerros.imagen
      formularioActualizarInfoPerros.current["Nombre"].value =
        infoPerros.nombre
      ...
      formularioActualizarInfoPerros.current["Genero"].value =
        infoPerros.genero
      formularioActualizarInfoPerros.current["Descripcion"].value =
        infoPerros.descripcion
      formularioActualizarInfoPerros.current["Caracter"].value =
        infoPerros.caracter
  ...
  return (
    <>
      {!infoPerros ? (
        ...
        <Texto
          {...infoPerros}
          actualizarInfoPerros={actualizarInfoPerros}
          updateInfoPerros={updateInfoPerros}
          formularioActualizarInfoPerros={formularioActualizarInfoPerros}
          formularioRefPerros={formularioRefPerros}
          infoRefPerros={infoRefPerros}
        />
      )}
    </>
  )
...
const Texto = (props) => {
  const {
    ...
    descripcion,
    caracter,
    actualizarInfoPerros,
    updateInfoPerros,
    formularioActualizarInfoPerros,
    formularioRefPerros,
    infoRefPerros,
  } = props
    ...
    <>
      ...
      <section className="Info" ref={infoRefPerros}>
        ...
        <div className="Info-col">
          ...
          <button className="Boton" onClick={actualizarInfoPerros}>
            Actualizar
          </button>
      ...
      <section className="Actualizar" ref={formularioRefPerros}>
        ...
        <form
          ...
          ref={formularioActualizarInfoPerros}
          onSubmit={updateInfoPerros}
        >
          <input
