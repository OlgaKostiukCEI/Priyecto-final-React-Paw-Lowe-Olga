      ...
      <section id="sobre-nosotros" className="Section-content">
        ...
        <div className="Section-texto">
          <h2 className="Section-texto-h2">
            Creando un Mundo Donde Cada Patita Encuentre un Hogar
          </h2>
          <p className="Section-texto-p">
            Imaginamos un mundo donde cada mascota tenga un hogar lleno de amor
            y cuidado. Trabajamos incansablemente para conectar a los animales
            necesitados con familias que les brinden una segunda oportunidad.
            Únete a nuestra misión y sé parte del cambio que garantiza que cada
            patita encuentre su lugar especial.
          </p>
        </div>
