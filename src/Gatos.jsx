      ...
      <GatosContent.Provider value={{ gatos, setGatos }}>
        <section id="gatos" className="Content">
          ...
          <p>
            ...
            Cada uno tiene su propia personalidad única, desde cariñosos y
            dulces hasta juguetones y aventureros.
          </p>
        </section>
      ...
      <section className="Section-col">
        ...
        <div className="Section-col-btn">
          <button className="Section-col-btn-mas">
            <NavLink className="Mas-info" to={`/info/${_id}`}>
              Más info
            </NavLink>{" "}
          </button>
          <button
            className="Section-col-btn-delete"
            onClick={() => borrarGato(_id)}
          >
            Eliminar
          </button>
        </div>
