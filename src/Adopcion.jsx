    ...
    <section className="Section-content Story">
      ...
      <div className="Happystory">
        ...
        <div className="Section-col-info">
          <img
            src="/happy-story-uno.jpg"
            alt=""
            className="Section-img-happystory"
          />
          <h4 className="Section-col-info-detail-happystory Nombre">
            Diego & Flex
          </h4>
          <p className="Section-col-info-detail-happystory Descripcion">
